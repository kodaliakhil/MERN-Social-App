...
const getUserProfile = async (req, res) => {
  //we will fetch profile with either username or user id
...
const updateUser = async (req, res) => {
  try {
    ...
    // With this we're gonna find all of the replies and we change the username and profilePic with the new updated information
